      ...
      if (post.comments.length > 0) {
        for (const comment of post.comments) {
          ...
          let topCommentSectionActions = $(
            "<div><p>" +
              comment.likes +
              "</p> <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512' class='heartIcon icon commentSectionIcon'><path d='M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8l0-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5l0 3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20-.1-.1s0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5l0 3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2l0-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z'/></svg><svg xmlns='http://www.w3.org/2000/svg' commentSectionIcon data-bs-toggle='modal' data-bs-target='#replyModal' xml:space='preserve' id='reply' class='icon replyIcon' x='0' y='0' version='1.1' viewBox='0 0 96 96'> <switch><foreignObject width='1' height='1' x='0' y='0' requiredExtensions='http://ns.adobe.com/AdobeIllustrator/10.0/'></foreignObject><g><path d='M56 36H17.656l18.628-18.627a4 4 0 0 0-5.657-5.657L5.172 37.171a4 4 0 0 0 0 5.657l25.455 25.456a4 4 0 0 0 5.657-5.657L17.658 44H56c15.464 0 28 12.536 28 28v4a4 4 0 0 0 8 0v-4c0-19.883-16.118-36-36-36z'></path></g></switch></svg></div>"
...
console.log($(window).scrollTop())
  ...
  $("main").scroll(function () {
    ...
    this.scrollTimer = setTimeout(() => {
      ...
      if (currentScrollPosition !== 0 || currentScrollPositionWindow !== initialScrollPosition) {
        $("#newPostBtn > p").hide();
        $("#newPostBtn").css({"padding": "10px"})
        $("#newPostBtn>img").css({"margin-right": "0px"})
      } else {
